                            ...
                            @foreach([
                                ...
                                <label class="relative cursor-pointer">
                                    <input
                                        ...
                                        value="{{ $plan }}"
                                        class="peer sr-only"
                                        {{ old('subscription_plan', $business->subscription_plan) === $plan ? 'checked' : '' }}
                                    >
                ...
                <x-ui.card title="Quick Guide">
                    <ul class="space-y-3 text-sm text-slate-600">
                        <li class="flex items-start gap-2">
                            ...
                            <span>Update the business name, type, and status as needed.</span>
                        </li>
                        <li class="flex items-start gap-2">
                            ...
                            <span>Modify contact details if the business information has changed.</span>
                        </li>
                        <li class="flex items-start gap-2">
                            ...
                            <span>Adjust the subscription plan when upgrading or downgrading.</span>
                        </li>
                    </ul>
                </x-ui.card>
